        ...
        function ajaxpost(){
            ...
            if(config.imgblod){
               ...
               $.ajax({
                    url :config.url,
                    method:'POST',
                    data : $.extend( {'base64Data':config.imgblod}, config.data ),
                    success : function(data) {
                       config.sucCallback(data);
                    },
                    error:function(err){
                        config.errCallback(err);
                    }
                });
                //$.ajax(config.url,{'base64Data':config.imgblod,'type':'base64'},function(data){
